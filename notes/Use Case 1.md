...
:raising_hand: Standard FHIR search works "out-of-the-box" for both and using meta.security seems counterintuitive for this use case.  Based on feedback, `meta.tag` element is supported by implementers.
...
:raising_hand: Client SHOULD apply tag/ Server MAY apply tag.
